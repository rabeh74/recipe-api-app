...
class BaseRecipeAttriputeView(mixins.UpdateModelMixin,mixins.DestroyModelMixin ,
...
class TagViewSet(BaseRecipeAttriputeView):
    ''' manage tags '''
...
class IngredientListView(BaseRecipeAttriputeView):
    ''' manage ingredients '''
